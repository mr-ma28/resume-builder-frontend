        ...
        <div className="text-center mb-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <p className="text-gray-600 text-lg">
              Build your perfect resume with our easy-to-use form
            </p>
          </div>
        </div>
              ...
              {hasData ? (
                <div className="space-y-6">
                  ...
                  <div className="text-center border-b border-gray-200 pb-4">
                    ...
                    {formData.summary && (
                      <p className="text-gray-700 text-sm mt-3 text-left">
                        {formData.summary}
                      </p>
                    )}
                  </div>
                            ...
                            <div
                              ...
                              <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-2">
                                ...
                                {(edu.startDate || edu.endDate) && (
                                  <div className="flex items-center gap-2 text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full whitespace-nowrap">
                                    <span>
                                      {edu.startDate} -{" "}
                                      {edu.endDate || "Present"}
                                    </span>
                  ...
                  {formData.projects.some((p) => p.title) && (
                    <div>
                      <h3 className="font-semibold text-gray-800 mb-2 flex items-center gap-2">
                        ...
                        Projects (
                        {formData.projects.filter((p) => p.title).length})
                      </h3>
                      <div className="space-y-2">
                        {formData.projects
                          .filter((p) => p.title)
